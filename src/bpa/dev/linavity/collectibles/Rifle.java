...
public class Rifle extends Item{
	...
	public Rifle(float x, float y) throws SlickException {
		super(x, y);
	}
	
	public Rifle(float x, float y, String itemImage) throws SlickException {
		super(x, y, itemImage);
	}
	
	public Rifle(float x, float y, float width, float height, String itemImage) throws SlickException {
