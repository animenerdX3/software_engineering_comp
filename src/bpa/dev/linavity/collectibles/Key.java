...
public class Key extends Item{
	...
	public Key(float x, float y, String itemImage) throws SlickException {
		super(x, y, itemImage);
	}
	
	public Key(float x, float y, float width, float height, String itemImage) throws SlickException {
