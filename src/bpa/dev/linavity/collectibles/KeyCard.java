...
public class KeyCard extends Item{
	...
	public KeyCard(float x, float y) throws SlickException {
		super(x, y);
	}
	
	public KeyCard(float x, float y, String itemImage) throws SlickException {
		super(x, y, itemImage);
	}
	
	public KeyCard(float x, float y, float width, float height, String itemImage) throws SlickException {
