...
public class GravPack extends Item{
	...
	public GravPack(float x, float y, String itemImage) throws SlickException {
		super(x, y, itemImage);
	}
	
	public GravPack(float x, float y, float width, float height, String itemImage) throws SlickException {
